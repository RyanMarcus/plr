...
impl GreedyPLR {
    ...
    pub fn new(gamma: f64) -> GreedyPLR {
        return GreedyPLR {
            ...
            gamma,
            s0: None, s1: None, sint: None, s_last: None,
    ...
    fn current_segment(&self, end: f64) -> Segment {
        ...
        let (sint_x, sint_y) = self.sint.as_ref().unwrap().to_tuple();
    ...
    pub fn process(&mut self, x: f64, y: f64) -> Option<Segment> {
        ...
        let new_state = match self.state {
            GreedyState::Need2 => { self.s0 = Some(pt); GreedyState::Need1 },
            GreedyState::Need1 => { self.s1 = Some(pt); self.setup(); GreedyState::Ready }
            GreedyState::Ready => {
